...
with open("./config/config_32b.yml", "r") as configfile:
...
EVENT2ACTION = {
    'BUTTONS': {
        str(evdev.ecodes.BTN_LEFT):   THIRTYTWO_BUTTON[mapMouse['BTN_LEFT']],
        str(evdev.ecodes.BTN_RIGHT):  THIRTYTWO_BUTTON[mapMouse['BTN_RIGHT']],
        str(evdev.ecodes.BTN_MIDDLE): THIRTYTWO_BUTTON[mapMouse['BTN_MIDDLE']],
        str(evdev.ecodes.BTN_SIDE):   THIRTYTWO_BUTTON[mapMouse['BTN_SIDE']],
        str(evdev.ecodes.BTN_EXTRA):  THIRTYTWO_BUTTON[mapMouse['BTN_EXTRA']],
        str(evdev.ecodes.KEY_A):      THIRTYTWO_BUTTON[mapKeyboard['KEY_A']],
        str(evdev.ecodes.KEY_B):      THIRTYTWO_BUTTON[mapKeyboard['KEY_B']],
        str(evdev.ecodes.KEY_X):      THIRTYTWO_BUTTON[mapKeyboard['KEY_X']],
        str(evdev.ecodes.KEY_Y):      THIRTYTWO_BUTTON[mapKeyboard['KEY_Y']],
        str(evdev.ecodes.KEY_1):      THIRTYTWO_BUTTON[mapKeyboard['KEY_1']],
        str(evdev.ecodes.KEY_2):      THIRTYTWO_BUTTON[mapKeyboard['KEY_2']],
        str(evdev.ecodes.KEY_3):      THIRTYTWO_BUTTON[mapKeyboard['KEY_3']],
        str(evdev.ecodes.KEY_4):      THIRTYTWO_BUTTON[mapKeyboard['KEY_4']],
        str(evdev.ecodes.KEY_5):      THIRTYTWO_BUTTON[mapKeyboard['KEY_5']],
        str(evdev.ecodes.KEY_6):      THIRTYTWO_BUTTON[mapKeyboard['KEY_6']],
        str(evdev.ecodes.KEY_7):      THIRTYTWO_BUTTON[mapKeyboard['KEY_7']],
        str(evdev.ecodes.KEY_8):      THIRTYTWO_BUTTON[mapKeyboard['KEY_8']]
    }, 
    'DIRECTIONS': {
    ...
    'OTHERS': {
        str(evdev.ecodes.REL_WHEEL): THIRTYTWO_BUTTON[mapOthers['REL_WHEEL']]
    }
}
