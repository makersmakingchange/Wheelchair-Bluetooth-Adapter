...
with open("./config/config_8b.yml", "r") as configfile:
...
EVENT2ACTION = {
    'BUTTONS': {
        str(evdev.ecodes.BTN_LEFT):   EIGHT_BUTTON[mapMouse['BTN_LEFT']],
        str(evdev.ecodes.BTN_RIGHT):  EIGHT_BUTTON[mapMouse['BTN_RIGHT']],
        str(evdev.ecodes.BTN_MIDDLE): EIGHT_BUTTON[mapMouse['BTN_MIDDLE']],
        str(evdev.ecodes.BTN_SIDE):   EIGHT_BUTTON[mapMouse['BTN_SIDE']],
        str(evdev.ecodes.BTN_EXTRA):  EIGHT_BUTTON[mapMouse['BTN_EXTRA']],
        str(evdev.ecodes.KEY_A):      EIGHT_BUTTON[mapKeyboard['KEY_A']],
        str(evdev.ecodes.KEY_B):      EIGHT_BUTTON[mapKeyboard['KEY_B']],
        str(evdev.ecodes.KEY_X):      EIGHT_BUTTON[mapKeyboard['KEY_X']],
        str(evdev.ecodes.KEY_Y):      EIGHT_BUTTON[mapKeyboard['KEY_Y']],
        str(evdev.ecodes.KEY_1):      EIGHT_BUTTON[mapKeyboard['KEY_1']],
        str(evdev.ecodes.KEY_2):      EIGHT_BUTTON[mapKeyboard['KEY_2']],
        str(evdev.ecodes.KEY_3):      EIGHT_BUTTON[mapKeyboard['KEY_3']],
        str(evdev.ecodes.KEY_4):      EIGHT_BUTTON[mapKeyboard['KEY_4']],
        str(evdev.ecodes.KEY_5):      EIGHT_BUTTON[mapKeyboard['KEY_5']],
        str(evdev.ecodes.KEY_6):      EIGHT_BUTTON[mapKeyboard['KEY_6']],
        str(evdev.ecodes.KEY_7):      EIGHT_BUTTON[mapKeyboard['KEY_7']],
        str(evdev.ecodes.KEY_8):      EIGHT_BUTTON[mapKeyboard['KEY_8']]
    }, 
    'DIRECTIONS': {
    ...
    'OTHERS': {
        str(evdev.ecodes.REL_WHEEL): EIGHT_BUTTON[mapOthers['REL_WHEEL']]
    }
}
